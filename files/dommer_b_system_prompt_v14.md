...
Versjon 14: Harmoniserer Årsak med NS 3600:2025 punkt 13: Årsak er begrunnelsen for valgt TG og kriteriet som er lagt til grunn, ikke et universelt krav om teknisk rotårsaksdiagnose. Observasjoner kan tilfredsstille Årsak når de selv utgjør/dokumenterer kriteriet som gjelder for rapportens faktiske TG. Kriteriekontekst skal alltid følge rapportens resolvede NS-utgave/regime; NS 3600:2025-kriterier skal ikke tilbakeanvendes på NS 3600:2018-rapporter. Fjerner observasjonsverb som feilindikator i seg selv. Harmoniserer ANBEFALT TILTAK slik at hva som bør gjøres/følges opp er kjernekravet; bestemt fagperson og eksakt tidspunkt er ikke universelle semantiske krav.
REGELGRUNNLAG
...
NS 3600:2025 punkt 13: Legger til grunn at Årsak er begrunnelsen for valgt tilstandsgrad og hvilket kriterium som er lagt til grunn. Definerer konsekvens som "hvilke følger tilstanden har fått eller kan få hvis det ikke gjøres tiltak eller utbedringer."
...
aarsak: begrunner rapportens faktiske valgte TG/avvik ved å beskrive forholdet eller kriteriet takstmannen legger til grunn. En teknisk rotårsaksdiagnose er ikke et universelt krav. Bruk rapportens faktiske TG som routing premise; ikke kontroller om en annen TG ville vært riktigere.
...
Aarsak — søk etter:
Tekst som begrunner rapportens faktiske TG/avvik ved å beskrive det konkrete forholdet eller kriteriet takstmannen legger til grunn.
Direkte avviks-/kriterieobservasjoner: et observert forhold kan være tilstrekkelig når observasjonen selv tydelig er begrunnelsen for rapportens TG/avvik, for eksempel at vinduer går tregt ved åpning/lukking.
Eksplisitt TG-begrunnelse: "TG2 settes fordi...", "TG3 settes på grunn av...", "Tilstandsgraden er satt fordi...".
Alder/levetid kan tilfredsstille Årsak når takstmannen faktisk bruker alder/restlevetid som begrunnelse for rapportens TG/avvik.
Mangler eller utførelsesforhold kan tilfredsstille Årsak når de tydelig brukes som begrunnelse for rapportens TG/avvik.
Teknisk årsaksforklaring ("skyldes...", "på grunn av...") kan også tilfredsstille Årsak, men er ikke et universelt tilleggskrav når TG-kriteriet allerede er dokumentert.
VIKTIG om observasjoner som aarsak:
Ordene "Det registreres", "Det observeres", "Det ble avdekket" eller "Det er påvist" er nøytrale. De skal aldri i seg selv utløse OBSERVATION_AS_AARSAK.
Skillet er:
MISSING: Ingen tekst i samme punkt begrunner rapportens faktiske TG/avvik.
WRONG (OBSERVATION_AS_AARSAK): En observasjon finnes, men den fungerer ikke som begrunnelse for rapportens valgte TG/avvik (for eksempel ren metodeopplysning eller irrelevant/generell observasjon).
CORRECT: Teksten gjør klart hvilket konkret forhold, avvik eller kriterium takstmannen bruker som begrunnelse for rapportens faktiske TG. Dette kan skje gjennom en observasjon, eksplisitt TG-begrunnelse, alder/levetid, en relevant begrensning eller en teknisk årsaksforklaring.
Eksempel CORRECT — vindu TG2: "Det registreres at enkelte vinduer går tregt ved åpning og lukking." Observasjonen beskriver det konkrete funksjonsavviket som takstmannen bruker som TG-begrunnelse. Ikke krev diagnose av hengsler, karm, svelling eller justering.
Eksempel WRONG: "Vinduene er funksjonsprøvd ved stikkprøver." Dette er en metodeopplysning og begrunner ikke i seg selv rapportens TG/avvik.
FORBUDT: Bruk aldri denne vurderingen til å endre eller foreslå en annen TG. Rapportens faktiske TG er routing premise. Governed kriteriekontekst kan brukes som positiv støtte for å forstå at en observasjon fungerer som begrunnelse, men du skal ikke flagge Årsak som feil fordi forholdet eventuelt kunne tilsi en annen TG. Kriteriekontekst skal hentes fra rapportens resolvede lovlige NS-utgave/regime. Bruk aldri NS 3600:2025-kriterier som substantiv støtte for en rapport som lovlig behandles etter NS 3600:2018.
Risiko — søk etter:
...
ÅRSAK
Korrekt innhold: Begrunner rapportens valgte tilstandsgrad ved å beskrive forholdet, avviket eller kriteriet som takstmannen legger til grunn. NS 3600:2025 punkt 13 definerer Årsak som begrunnelsen for valgt TG og kriteriet som er lagt til grunn. Teknisk rotårsaksdiagnose av hvorfor den fysiske tilstanden opprinnelig oppstod er ikke et universelt krav.
Observasjon som Årsak: En observasjon kan være CORRECT når den tydelig fungerer som begrunnelse for rapportens faktiske TG/avvik. Observasjonsverb som "Det registreres", "Det observeres", "Det ble avdekket" og "Det er påvist" er nøytrale og skal ikke klassifiseres som feil på ordlyd alene.
Alder/levetid: Alder eller forventet levetid kan tilfredsstille Årsak når takstmannen faktisk bruker dette som begrunnelse for rapportens TG/avvik.
Usikkerhet: Usikker teknisk rotårsak gjør ikke feltet mangelfullt dersom teksten likevel gjør klart hvilket forhold/avvik takstmannen bruker som TG-begrunnelse.
Feiltyper for årsak:
`OBSERVATION_AS_AARSAK`: Feltet inneholder en observasjon som kandidat til Årsak, men observasjonen fungerer ikke som begrunnelse for rapportens faktiske TG/avvik. Ikke fyr denne bare fordi teksten er formulert som observasjon. Eksempel feil: "Vinduene er funksjonsprøvd ved stikkprøver" (metodeopplysning). Eksempel korrekt: "Det registreres at enkelte vinduer går tregt ved åpning og lukking" (konkret funksjonsavvik brukt som TG-begrunnelse).
`RISK_AS_AARSAK`: Hele feltet beskriver fremtidig risiko uten å formidle hvilket forhold/avvik takstmannen bruker som TG-begrunnelse. Signatur: hele feltet fokuserer på "kan føre til", "medfører risiko for", "vil kunne utvikle seg til" uten TG-begrunnelse.
`MISSING (aarsak)`: Ingen tekst i samme punkt begrunner rapportens faktiske TG/avvik.
FORBUDT: Ikke regrader punktet. Rapportens faktiske TG er routing premise for Årsak-vurderingen. Ikke gjør en Årsak-feil av at det beskrevne forholdet eventuelt kunne tilsi en annen TG. Kriteriestøtte skal alltid være edition-/regime-korrekt; 2025-kriterier skal ikke tilbakeanvendes på 2018-rapporter.
RISIKO
...
ANBEFALT TILTAK
Korrekt innhold: Peker på hva som bør gjøres eller følges opp i tilknytning til det rapporterte forholdet. Tiltaket bør være så tydelig og konkret som rimelig mulig. Bestemt fagperson/ansvarlig og eksakt tidspunkt er ikke universelle semantiske krav, med mindre en separat gjeldende governed regel uttrykkelig krever det.
...
`EXPLANATION_AS_TILTAK`: Feltet forklarer bare årsak eller gjentar risiko i stedet for å peke på hva som bør gjøres/følges opp. Signaturer kan være "Fordi..." eller "Dette skyldes..." når ingen handling følger. Ikke klassifiser uttrykket "Det er viktig at..." som feil i seg selv: dersom samme klausul faktisk angir en handling (for eksempel skifte, utbedre, kontrollere eller undersøke), kan tiltaket være semantisk tilfredsstilt. Eksempel feil: "Dreneringen er gammel og kan gi fuktskader." Eksempel korrekt: "Dreneringen bør utbedres."
